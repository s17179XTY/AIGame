              ...
              {worlds.map((world) => (
                ...
                >
                  <div className="flex items-center gap-4 flex-1 min-w-0">
                    <div className="w-11 h-11 rounded-xl bg-gradient-to-br from-indigo-500/30 to-purple-500/20 flex items-center justify-center text-xl shrink-0 ring-1 ring-white/[0.06]">
                      🌍
                    </div>
