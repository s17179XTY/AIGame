            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-xs text-game-muted/50 mt-1">
                  選擇 API 格式，OpenAI 相容格式可用於大多數代理/自託管服�?
                </p>
              </div>
              ...
              <div>
                ...
                />
                <p className="text-xs text-game-muted/50 mt-1">
                  例如: https://api.openai.com/v1 �?https://your-proxy.com/v1
                </p>
              </div>
                ...
                <>
                  <div>
                    ...
                    >
                      ...
                      <option value="standard">標準（場�?+ 重要行為�?/option>
