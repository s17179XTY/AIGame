export default {
  ...
  worldSettingsModal: { title: 'ワールド設定', worldSettings: '設定', characters: 'キャラクター', saveWorld: 'ワールド設定を保存', saving: '保存中...', saveFailed: '保存失敗', editChar: 'キャラクター編集', backToList: '← リストに戻る', deleteCharConfirm: 'このキャラクターを削除しますか？', deleteFailed: '削除失敗', saved: '保存済み', addCharacter: 'キャラクター追加', noCharacters: 'この世界にキャラクターはありません', player: '主人公', close: '閉じる' },
  gmPanel: {
    title: 'GMパネル',
